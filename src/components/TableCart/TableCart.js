...
var body={ billtime:getCurrentTime(), billdate:getCurrentDate(), tableno:props.tableNo, server:props.waiterName, fssai:admin.fssaino, cnote:'', gst:admin.gstno, billingdetails:JSON.stringify(foodOrder[props.tableNo]), totalamount:(totalAmount-totalOffer)+((totalAmount-totalOffer)*admin.gsttype/100), customername, mobileno}
